...
(function($) {
   ...
   $.Scrollax();
    ...
    // Navbar Dropdown
	// Make the Profile dropdown toggle on click and stay open until toggled again
    $('#dropdown04').on('click', function(e) {
        // Prevent any link jump
        e.preventDefault();
        // Important: stop click from bubbling to document
        e.stopPropagation();
    ...
    // Quantity Increase and Decrese in Details Page
